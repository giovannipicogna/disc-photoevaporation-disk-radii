...
path = paths.data / 'pop_compact_reduced/'
...
sns.histplot(data=data_compact, x="age", y="mdot_acc", bins=(100, 100),
...
# Plot second panel: extended discs
...
ax_main[1].set_title('Extended discs', fontsize=10)
...
# Save figure
fig.savefig(paths.figures / 'Fig61.png', format='png', bbox_inches='tight')
print("Figure saved as: Fig61.png")
