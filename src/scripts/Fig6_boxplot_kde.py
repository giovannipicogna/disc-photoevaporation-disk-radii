...
# Set font sizes optimized for two-column A4 layout
# plt.rc('font', size=8.)
...
# ============================================================================
# Create main figure optimized for A4 two-column layout
fig = plt.figure(figsize=(6.69291, 4.))
...
# ============================================================================
# Define data paths
data_path = "/e/ocean1/users/picogna/Photoevaporation-OuterRadius-Project/"

# Data filtering parameters
mask = False          # No additional masking applied
mask_val = 1.e-14     # Threshold value for potential masking

# Load population synthesis data for old prescription (EUV-only)
path = data_path + 'pop_compact_discs_old/'
...
path = data_path + 'pop_compact_discs_new/'
...
acc_data = pd.read_csv('../data/data-PPVII.csv', sep='\t')
...
low_acc_data = pd.read_csv('../data/low_accretors.dat', sep=r'\s+')
...
x_bin_width = 0.1*20./2.  # Same as histogram binwidth
...
ax_main[0].set_title("Old prescription", fontsize=10)
...
ax_main[1].set_title("Critical radius dependence", fontsize=10)
...
# Save figure
fig.savefig('Fig6_boxplot_kde.png', format='png', dpi=400, bbox_inches='tight')
...
print("\nPublication-quality Figure 6 generated successfully!")
print("Output: Fig6_boxplot_kde.png (400 DPI)")
