...
def create_combined_corner_plot(data_list,
                                output_file='combined_corner_A4.png'):
...
def main():
    ...
    base_dir = ("/e/ocean1/users/picogna/Photoevaporation-OuterRadius-Project/"
                "pop_compact_discs_new/")
    ...
    mstar_vals, lx_vals, r1_vals, m0_vals = create_combined_corner_plot(
        data_list, 'combined_corner_A4_horizontal.png')
