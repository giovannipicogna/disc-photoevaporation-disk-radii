...
def main():
    ...
    run_configs = {
        '5au': {
            'new': paths.data / "single_internal_5au",
            'old': paths.data / "single_internal_5au_norcrit",
            'factor10': paths.data / "single_internal_5au_factor10",
            'label': '5 AU'
        },
        '20au': {
            'new': paths.data / "single_internal_20au",
            'old': paths.data / "single_internal_20au_norcrit",
            'factor10': paths.data / "single_internal_20au_factor10",
            'label': '20 AU'
        },
        '80au': {
            'new': paths.data / "single_internal_80au",
            'old': paths.data / "single_internal_80au_norcrit",
            'factor10': paths.data / "single_internal_80au_factor10",
            'label': '80 AU'
        }
    }
    ...
    # ========================================================================
    # Create figure optimized for MNRAS two-column (3 rows x 3 columns)
    # Share x-axis within columns and y-axis within rows
    fig, axes = plt.subplots(3, 3, figsize=(20/3, 5.),
                             sharex='col', sharey='row')
    fig.subplots_adjust(left=0.08, bottom=0.12, right=0.92, top=0.80,
    ...
    for config_key, config_data in run_configs.items():
        ...
        # Process new, old, and factor10 prescriptions for this configuration
        for col_idx, prescription in enumerate(['new', 'old', 'factor10']):
            ...
            prescription_name = prescription_names.get(prescription, prescription)
            ...
            # Add subplot labels (a, b, c, d, e, f, g, h, i)
    ...
    output_file = paths.figures / 'Fig4_expanded.png'
    ...
    print("Optimized for two-column A4 scientific publication")
    print("Grid layout: 3 rows × 3 columns")
