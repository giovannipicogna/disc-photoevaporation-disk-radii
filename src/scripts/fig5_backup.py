...
ax_main = [
    fig.add_subplot(gs[0, 1], sharex=ax_kde_age),  # Panel a: Compact discs
    fig.add_subplot(gs[0, 2], sharex=ax_kde_age),  # Panel b: Compact discs reduced PE
    fig.add_subplot(gs[0, 3], sharex=ax_kde_age)   # Panel c: Extended discs
]
