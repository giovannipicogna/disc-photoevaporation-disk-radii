...
def main():
    ...
    run_configs = {
        '5au': {
            'new': paths.data / "test_single_planet_new/run0",
            'old': paths.data / "test_single_planet_old/run0",
            'label': '5 AU'
        },
        '20au': {
            'new': paths.data / "test_single_planet_new_20au/run0",
            'old': paths.data / "test_single_planet_old_20au/run0",
            'label': '20 AU'
        },
        '80au': {
            'new': paths.data / "test_single_planet_new_80au/run0",
            'old': paths.data / "test_single_planet_old_80au/run0",
            'label': '80 AU'
        }
    }
